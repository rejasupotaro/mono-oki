...
class ApksControllerTest < ActionController::TestCase
  ...
  test "should create apk" do
    assert_difference('Apk.count') do
      post :create, apk: { desc: @apk.desc, link: @apk.link, memo: @apk.memo, tag: @apk.tag, title: @apk.title }
    end
  ...
  test "should update apk" do
    put :update, id: @apk, apk: { desc: @apk.desc, link: @apk.link, memo: @apk.memo, tag: @apk.tag, title: @apk.title }
    assert_redirected_to apk_path(assigns(:apk))
  end
